...
const TokenList = React.memo(() => {
  ...
  React.useEffect(() => {
      ...
      (token: PrototypePair) => {
        return {
          ...
          priceChangePercentage1h:
            token.priceChangePercentage1h,
          priceChangePercentage24h:
            token.priceChangePercentage24h,
          price: token.price,
          volumeChangePercentage24h:
            token.volumeChangePercentage24h,
          volume: token.volume,
    ...
    if (tokens.length) {
      sendMessage({
        ...
        id: 'price',
        data: {
          cryptoIds: tokens.flatMap(
            (t) => t.cmcId,
          ) as unknown as JsonPrimitive,
          index: 'detail',
        },
      })
    }
  ...
  const pages = React.useMemo(
    () => Math.ceil(tableData.tokensCount / rowsShow),
    [tableData.tokensCount, rowsShow],
  )
  ...
  return (
    <div className={s.TokenListPage__Container}>
      <div className={s.TokenListPage__headingContainer}>
        <h1 className={s.TokenListPage__heading}>
          DEX Rank
        </h1>
        <div
          className={s.TokenListPage__headingInputContainer}
        >
          <div
            className={
              s.TokenListPage__headingInputContainerBackground
            }
          />
          <div
            className={
              s.TokenListPage__headingInputContainerIcon
            }
          >
            <SearchIcon />
          </div>
          <input
            className={s.TokenListPage__headingInput}
      ...
      <div
        className={
          s.TokenListPage__headingSelectorContainer
        }
      >
        <NetworkSelect />
      </div>
      <div className={s.TokenListPage__scrollContainer}>
        ...
        >
          <TableHeader>
            ...
            <HeaderCell
              {...getHeaderCellProps(SortByColumn.NAME)}
            >
              Name
            </HeaderCell>
            <HeaderCell
            ...
            <HeaderCell
              {...getHeaderCellProps(
                SortByColumn.CIRCULATION_SUPPLY,
              )}
            >
              Circulation Supply
            </HeaderCell>
                ...
                .map((token, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <RowText>
                        {valueOrDash(millify(token.volume))}
                      </RowText>
                      ...
                      <RowText>
                        {valueOrDash(
                          millify(token.circulatingSupply),
                        )}
                      </RowText>
                      <RowText>
                        {valueOrDash(
      ...
      <TableFooter
        ...
        showTo={
          tableData.tokensCount &&
          Math.min(page * rowsShow, tableData.tokensCount)
        }
